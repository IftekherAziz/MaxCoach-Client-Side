    ...
    return (
      <section className="mb-12 mx-10 md:mx-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-20 ">
              ...
              <div className="flex-shrink-0">
                <div className="relative inline-block">
                  <a href="#" className="relative block">
                    <img
                      alt="profile"
                      src="https://demo.athemes.com/sydney-lms/wp-content/uploads/sites/134/2022/07/image-43.jpg"
          ...
          <div className=" p-10  rounded-lg shadow bg-zinc-50 text-black">
            <div className="flex items-start text-left">
              <div className="flex-shrink-0">
                <div className="relative inline-block">
                  <a href="#" className="relative block">
                    <img
                      alt="profile"
                      src="https://demo.athemes.com/sydney-lms/wp-content/uploads/sites/134/2022/07/pexels-spencer-selover-775358.jpg"
                      className="mx-auto object-cover rounded-full h-16 w-16 "
                    />
                  </a>
                  <svg
              ...
              <div className="flex-shrink-0">
                <div className="relative inline-block">
                  <a href="#" className="relative block">
                    <img
                      alt="profile"
                      src="https://demo.athemes.com/sydney-lms/wp-content/uploads/sites/134/2022/07/image-43-2.jpg"
                      className="mx-auto object-cover rounded-full h-16 w-16 "
                    />
                  </a>
                  <svg
