...
const Footer = () => {
  return (
    <div className="border-t overflow-hidden">
        ...
        <div>
          ...
          <div className="form-control w-80">
            ...
            <div className="flex">
              ...
              />
              <button className="btn btn-neutral top-0 right-0 rounded-l-none">
                Subscribe
              </button>
            </div>
          </div>
      ...
      <div className="footer items-center py-6 md:px-0 px-6  max-w-7xl mx-auto border-t">
        <div className="items-center grid-flow-col">
          <p>MaxCoach © 2023 - All right reserved</p>
        </div>
